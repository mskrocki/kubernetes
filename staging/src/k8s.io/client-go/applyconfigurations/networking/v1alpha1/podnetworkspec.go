...
type PodNetworkSpecApplyConfiguration struct {
	...
	ParametersRef *ParametersRefApplyConfiguration `json:"parametersRef,omitempty"`
...
func (b *PodNetworkSpecApplyConfiguration) WithParametersRef(value *ParametersRefApplyConfiguration) *PodNetworkSpecApplyConfiguration {
